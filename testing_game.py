...
def main():
    ...
    good_brain = neural_net.Neural_Network(4, 4, 1)

    good_brain.first_weights_matrix = [[-0.48297112, -0.02776738, -0.94286725, -0.42023943],
                                       [ 0.07506252, -0.50448914,  0.69481074, -0.4159613 ],
                                       [-1.11589848,  0.64793701,  0.34540193,  0.23519645],
                                       [-0.39149675,  0.29970105, -0.92300241,  0.88874591]]
    good_brain.second_weights_matrix = [[ 0.37874971,  0.77102025,  0.01516304, -0.8265013 ]]
    good_brain.first_bias = [[0.08561032],
                             [0.06382156],
                             [1.03522473],
                             [0.29498559]]
    good_brain.second_bias = [[-0.01969226]]

    good_jumper = Ball(good_brain)

    jumpers = genetic.Population(SIZE_POPULATION)

    jumpers.population[-1] = good_jumper
